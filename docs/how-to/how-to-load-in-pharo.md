# How to load Open-AI in a Pharo image
...
4. Evaluate:
    ...
    Metacello new
      baseline: 'OpenAI';
      repository: 'github://pharo-ai/Open-AI:release-candidate';
      load: 'Development'.
    ```
...
5. Select *Clone from github.com* and enter `pharo-ai` as owner name and `Open-AI`
   as project name
6. Click *Ok*
7. Select the repository in the main Iceberg window
8. Open the contextual menu and select
  *Metacello -> Install baseline of Open-AI ...*
